...
from conv_script import Conversion
...
conversion.converter(config.embeddings_path, config.deep_embeddings_path, config.embed_dims)
...
def main():
    ...
    parser.add_argument("--emb", default='embedz_deep', help='Embeddings file')
    parser.add_argument("--network", default='../Datasets/blogcatalog/blogcatalog.mat',
